...
The primary goal is to provide a comprehensive alerting management UI.

It aims to reduce alerts noise and improve the overall user experience for monitoring and responding to issues, including adding an alert `component` and impact `layer` context, to enable calculating an aggregated cluster and component health, to help users address the most impactful issues first.
...
- Use consistent multi‑cluster terms:
  ...
  - Impact group (Cluster/Namespace) and Component
